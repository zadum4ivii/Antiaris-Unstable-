...
{	
	class ProjectileStop : GlobalProjectile
    {
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            if (mod.GetModWorld<AntiarisWorld>().frozenTime && Tick >= 4 && projectile.aiStyle != 19 && projectile.aiStyle != 20 && projectile.aiStyle != 7 && projectile.aiStyle != 99 && projectile.aiStyle != 75 && projectile.aiStyle != 13 && projectile.aiStyle != 140 && projectile.aiStyle != 142 && !projectile.minion && projectile.type != mod.ProjectileType("Warbanner") && projectile.type != mod.ProjectileType("Vanguard") && projectile.type != mod.ProjectileType("VoltCharge") && projectile.type != mod.ProjectileType("TimeWave"))
            {
				projectile.timeLeft++;
        ...
        {
			var player = Main.player[Main.myPlayer];
            if (mod.GetModWorld<AntiarisWorld>().frozenTime && projectile.aiStyle != 19 && projectile.aiStyle != 20 && projectile.aiStyle != 7 && projectile.aiStyle != 99 && projectile.aiStyle != 75 && projectile.aiStyle != 13 && projectile.aiStyle != 140 && projectile.aiStyle != 142 && !projectile.minion && projectile.type != mod.ProjectileType("Warbanner") && projectile.type != mod.ProjectileType("Vanguard") && projectile.type != mod.ProjectileType("VoltCharge"))
            {
                return false;
            }
            else
