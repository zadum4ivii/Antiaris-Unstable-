    ...
    public class AntiarisItems : GlobalItem
    {
        ...
        public override void OpenVanillaBag(string context, Player player, int arg)
        {
            if (context == "bossBag" && Main.rand.Next(30) == 0)
            {
                ...
                {
                    case 0:
                        player.QuickSpawnItem(mod.ItemType("Zadum4iviiProtectiveMask"));
                        player.QuickSpawnItem(mod.ItemType("Zadum4iviiProtectiveBreastplate"));
                        player.QuickSpawnItem(mod.ItemType("Zadum4iviiProtectiveGreaves"));
                        break;
					case 1:
                        ...
                        break;
					case 2:
                        player.QuickSpawnItem(mod.ItemType("NokilosAngelicHood"));
                        player.QuickSpawnItem(mod.ItemType("NokilosAngelicChestplate"));
                        player.QuickSpawnItem(mod.ItemType("NokilosAngelicGreaves"));
                        break;
					case 3:
            ...
            {
                player.QuickSpawnItem(mod.ItemType("HeavenlyClock"));
            }
        }
        ...
        {
            if (type == mod.ItemType("Pufferfish"))
            {
