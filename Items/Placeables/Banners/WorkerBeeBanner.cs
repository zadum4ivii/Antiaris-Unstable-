...
namespace Antiaris.Items.Placeables.Banners
{
    public class WorkerBeeBanner : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Знамя рабочей пчелы");
            Tooltip.AddTranslation(GameCulture.Russian, "Игроки поблизости получают бонус против: Рабочая пчела");
        }
    }
}
