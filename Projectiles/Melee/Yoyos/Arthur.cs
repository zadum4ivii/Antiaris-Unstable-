    ...
    class Arthur : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            if (crit)
            {
                ...
                value17.Normalize();
                value17 *= (float)(500) * 0.01f;
                var Sword = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value17.X, value17.Y, ProjectileID.EnchantedBeam, projectile.damage, 1f, projectile.owner, 0f);
